...
function calendar_edit_entry(calEvent,$event){
	...
	$.getJSON('./calendar.php?action=get_event&id='+calEvent.id,function(eventdata){
		$('<div id="calendar_edit_entry_form" title="Edit Calendar Entry">event name<br /><input id="calendar_edit_entry_form_title" value="'+eventdata.title+'" /><br />body text<br /><textarea style="width:400px;height:200px" id="calendar_edit_entry_form_body">'+eventdata.body+'</textarea></div>').appendTo($('body'));
